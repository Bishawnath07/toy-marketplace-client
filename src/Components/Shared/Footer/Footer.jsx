import img from '../NavBer/image/a6bc59dd3d2c02e80c45e6eb64b439d5-toys-shop-logo.png'

const Footer = () => {
    return (
        <footer>
        <div  className="footer p-10 bg-base-200 grid grid-cols-3 text-base-content">
        <div>
      ...
      <p className='text-center py-10'>Copyright © 2023 - All right reserved by IPC Chronic Toys Insecurity</p>
        </div>
      </footer> 
    );
};
